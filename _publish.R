...
i = 1
s = paste0('title: "Improving Usability of Snow Data through Web-based Visualizations & Tutorials (', c('Bootstrap', 'Tufte'), ' Style)"')
for (fmt in c('html_book', 'tufte_html_book')) {
  ...
  i = i + 1
  bookdown::publish_book(paste0('Technical_Documentation', i))
}
unlink('_book', recursive = TRUE)
...
bookdown::publish_book('Technical_Documentation')
